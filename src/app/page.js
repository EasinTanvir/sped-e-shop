      ...
      <section className="border-y border-zinc-200 bg-white px-5 py-10">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
          {[
            [
              "Signed-in ordering",
              "Visitors can browse freely, but only logged-in customers can place COD orders.",
            ],
            [
              "Product showcase",
              "Clean product pages with pricing, stock, images, and account-aware checkout.",
            ],
            [
              "Panels for everyone",
              "Admins manage products and orders. Customers track their own order status.",
            ],
          ].map(([title, text]) => (
            <div
              key={title}
